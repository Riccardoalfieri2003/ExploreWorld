...
MareMontagnaCittaModel=load_model('Models/MareMontagnaCittaModel/MareMontagnaCitta_classifier.h5')



#result_list=getURLs("Waikiki Honolulu","Specifico")
...
result_list=['https://bigisland.org/wp-content/uploads/2021/03/naturehawaii.jpg']
...
for url in result_list:
    ...
    try:
        ...
        print("MontagnaPrediction: ", MontagnaPrediction)
