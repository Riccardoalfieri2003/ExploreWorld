...
train_datagen = ImageDataGenerator(
    ...
    zoom_range=(0.8,1.2),  # Zoom casuale
    ...
    brightness_range=[0.8, 1.2]  # Random brightness adjustment between 0.5 and 1.5 times the original brightness
)
...
history = model.fit(
    train_generator,
    epochs=10,  # Puoi regolare il numero di epoche
    validation_data=test_generator
)

model.save('Mare_classifier.h5')
